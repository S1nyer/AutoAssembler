...
namespace Example
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            long ThreadMemory = MemoryAPI.GetAddress("ThreadMemory");
            ...
            //WriteMemoryString 函数的参数Coding：0表示ASCII单字节编码，1表示Unicode双字节编码
            //WriteMemoryString function parameter Coding:0 is ASCII encoding,1 is Unicode encoding
            MemoryAPI.WriteMemoryString(ThreadMemory, s, 1);
            ...
            s = MemoryAPI.ReadMemoryString(ThreadMemory, 0, 1);
